...
(* OASIS_START *)
(* DO NOT EDIT (digest: cd70e6822227c40b22e10597267bf889) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Miguel A. Yanez"];
          homepage = None;
          synopsis = "NOAA API & Command Line tool";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "6¿!a‹ˆÓ\145\158§œ\134\152\014\024=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
